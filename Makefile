...
startc: ## Spin up current container
	docker-compose up -d 

stopc: ## Shut down current container
	docker-compose down 

buildc: ## Build all current docker images
	docker-compose up --build tdlist

moichido: ## Docker compose down, up and build for current project
	@make stopc
	@make startc
	@make buildc

show: ## serving in artisan for specific port development environment
